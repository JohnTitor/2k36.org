  ...
  return (
    <div className="bg-white dark:bg-black">
      <Head>
        ...
        <meta name="twitter:site" content="@fr4ternite" />
      ...
      <nav className="sticky-nav flex justify-between items-center max-w-4xl w-full p-8 my-0 md:my-8 mx-auto bg-white dark:bg-black opacity-80 bg-opacity-60">
